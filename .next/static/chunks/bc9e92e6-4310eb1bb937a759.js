"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{Bt:function(){return sP},ET:function(){return sV},IO:function(){return su},JU:function(){return iM},PL:function(){return sD},QT:function(){return sb},TQ:function(){return sw},Xo:function(){return sm},ad:function(){return iU},ar:function(){return sc},b9:function(){return sg},cf:function(){return sM},hJ:function(){return iV},nP:function(){return sU},oe:function(){return sL},pl:function(){return sR},r7:function(){return sx}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(9767);var f=n(951).lW;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tv(e,t){if(e.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:J(t)?"-0":t}}function t_(e){return{integerValue:""+e}}function tE(e,t){return"number"==typeof t&&Number.isInteger(t)&&!J(t)&&t<=Number.MAX_SAFE_INTEGER&&t>=Number.MIN_SAFE_INTEGER?t_(t):tv(e,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tT{constructor(){this._=void 0}}function tI(e,t){return e instanceof tk?eb(t)||t&&"doubleValue"in t?t:{integerValue:0}:null}class tC extends tT{}class tA extends tT{constructor(e){super(),this.elements=e}}function tN(e,t){let n=tR(t);for(let t of e.elements)n.some(e=>eE(e,t))||n.push(t);return{arrayValue:{values:n}}}class tS extends tT{constructor(e){super(),this.elements=e}}function tb(e,t){let n=tR(t);for(let t of e.elements)n=n.filter(e=>!eE(e,t));return{arrayValue:{values:n}}}class tk extends tT{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function tD(e){return ed(e.integerValue||e.doubleValue)}function tR(e){return ek(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n1{constructor(){this.ao=()=>this.uo(),this.co=()=>this.lo(),this.ho=[],this.Po()}_o(e){this.ho.push(e)}shutdown(){window.removeEventListener("online",this.ao),window.removeEventListener("offline",this.co)}Po(){window.addEventListener("online",this.ao),window.addEventListener("offline",this.co)}uo(){for(let e of(v("ConnectivityMonitor","Network connectivity changed: AVAILABLE"),this.ho))e(0)}lo(){for(let e of(v("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE"),this.ho))e(1)}static D(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let n2=null;function n4(){return null===n2?n2=268435456+Math.round(2147483648*Math.random()):n2++,"0x"+n2.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sC{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class sA extends sr{constructor(e,t,n,r,i,s){super(e,t,n,r,s),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){let t=new sN(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){let n=this._document.data.field(ss("DocumentSnapshot.get",e));if(null!==n)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class sN extends sA{data(e={}){return super.data(e)}}class sS{constructor(e,t,n,r){this._firestore=e,this._userDataWriter=t,this._snapshot=r,this.metadata=new sC(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){let e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(e,t){this._snapshot.docs.forEach(n=>{e.call(t,new sN(this._firestore,this._userDataWriter,n.key,n,new sC(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){let t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new A(C.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(n=>{let r=new sN(e._firestore,e._userDataWriter,n.doc.key,n.doc,new sC(e._snapshot.mutatedKeys.has(n.doc.key),e._snapshot.fromCache),e.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:t++}})}{let n=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3!==e.type).map(t=>{let r=new sN(e._firestore,e._userDataWriter,t.doc.key,t.doc,new sC(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),i=-1,s=-1;return 0!==t.type&&(i=n.indexOf(t.doc.key),n=n.delete(t.doc.key)),1!==t.type&&(s=(n=n.add(t.doc)).indexOf(t.doc.key)),{type:function(e){switch(e){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return I()}}(t.type),doc:r,oldIndex:i,newIndex:s}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sb(e){e=ib(e,ix);let t=ib(e.firestore,iP);return(function(e,t,n={}){let r=new N;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ip({next:o=>{s.Za(),t.enqueueAndForget(()=>r$(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rQ(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rB(e,a)})(await iE(e),e.asyncQueue,t,n,r)),r.promise})(iq(t),e._key).then(n=>sF(t,e,n))}class sk extends sT{constructor(e){super(),this.firestore=e}convertBytes(e){return new iB(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new ix(this.firestore,null,t)}}function sD(e){e=ib(e,iR);let t=ib(e.firestore,iP),n=iq(t),r=new sk(t);return sa(e._query),(function(e,t,n={}){let r=new N;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ip({next:n=>{s.Za(),t.enqueueAndForget(()=>r$(e,a)),n.fromCache&&"server"===r.source?i.reject(new A(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rQ(n,s,{includeMetadataChanges:!0,_a:!0});return rB(e,a)})(await iE(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sS(t,r,e,n))}function sR(e,t,n){e=ib(e,ix);let r=ib(e.firestore,iP),i=sI(e.converter,t,n);return sO(r,[iZ(iJ(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tV.none())])}function sx(e,t,n,...r){e=ib(e,ix);let i=ib(e.firestore,iP),s=iJ(i);return sO(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof i$?function(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[i6(t,r,n)],l=[i];if(s.length%2!=0)throw new A(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i6(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!sn(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Nu(t);if(n instanceof i0)u.push(t);else{let e=i3(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iW(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Qu(1,t,n);i5("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=se(t,e,n);r=(0,h.m9)(r);let l=i.Nu(o);if(r instanceof i0)s.push(o);else{let e=i3(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iW(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tV.exists(!0))])}function sL(e){return sO(ib(e.firestore,iP),[new tG(e._key,tV.none())])}function sV(e,t){let n=ib(e.firestore,iP),r=iM(e),i=sI(e.converter,t);return sO(n,[iZ(iJ(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tV.exists(!1))]).then(()=>r)}function sM(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iF(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iF(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof ix)a=ib(e.firestore,iP),o=e5(e._key.path),s={next:n=>{t[u]&&t[u](sF(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=ib(e,iR);a=ib(n.firestore,iP),o=n._query;let r=new sk(a);s={next:e=>{t[u]&&t[u](new sS(a,r,n,e))},error:t[u+1],complete:t[u+2]},sa(e._query)}return function(e,t,n,r){let i=new ip(r),s=new rQ(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rB(await iE(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>r$(await iE(e),s))}}(iq(a),o,c,s)}function sO(e,t){return function(e,t){let n=new N;return e.asyncQueue.enqueueAndForget(async()=>r9(await i_(e).then(e=>e.syncEngine),t,n)),n.promise}(iq(e),t)}function sF(e,t,n){let r=n.docs.get(t._key),i=new sk(e);return new sA(e,i,t._key,r,new sC(n.hasPendingWrites,n.fromCache),t.converter)}function sP(){return new i1("serverTimestamp")}function sU(e){return new i2("increment",e)}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iP(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new A(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ew(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);